    ...
    <section id="projects" className="bg-[#173138] text-white" aria-labelledby="projects-heading">
      <div className="mx-auto max-w-7xl px-5 py-24 sm:px-8 lg:py-32">
        <div className="grid gap-10 border-b border-white/20 pb-12 lg:grid-cols-[.8fr_1.2fr] lg:items-end">
          <div><p className="text-xs font-black uppercase tracking-[0.2em] text-[#a7d9d7]">Projects</p><h2 id="projects-heading" className="mt-5 text-4xl font-black leading-tight sm:text-5xl">Turning ideas into usable visual systems.</h2></div>
          <p className="max-w-xl border-l border-[#e57356] pl-6 text-lg leading-8 text-white/75">Each project pairs structured thinking with clear communication - shaping information into a form people can understand and use.</p>
        </div>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2">
          ...
          >
            ...
            <div className="relative flex h-full flex-col"><div className="flex items-start justify-between gap-5"><div><p className="text-xs font-black uppercase tracking-[0.18em] text-[#e57356]">Project 01</p><h3 className="mt-4 text-2xl font-black leading-tight text-white sm:text-3xl">Strategic Foresight Toolkit Design</h3><p className="mt-3 max-w-xl text-sm leading-7 text-white/70">Global Futures Laboratory · Visual identity, modular layouts, diagrams, and workshop-ready toolkit design.</p></div><span className="grid h-11 w-11 shrink-0 place-items-center rounded-full border border-white/25 text-[#a7d9d7] transition group-hover:bg-[#a7d9d7] group-hover:text-[#173138]"><ArrowDown size={18} className={`transition-transform duration-300 ${isRiipenProjectOpen ? "rotate-180" : ""}`} aria-hidden="true" /></span></div><div className="mt-auto pt-8"><div className="flex flex-wrap items-center gap-3 border-t border-white/15 pt-5 text-xs font-bold uppercase tracking-[0.1em] text-white/65"><span>August 2026</span><span className="h-1 w-1 rounded-full bg-[#e57356]" /><span>5.0 feedback</span><span className="h-1 w-1 rounded-full bg-[#e57356]" /><span>Riipen</span></div><p className="mt-5 text-sm font-bold text-[#a7d9d7]">{isRiipenProjectOpen ? "Close case study" : "Explore the full case study"}</p></div></div>
          </button>
        </div>
        ...
        <motion.article id="riipen-case-study" initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.35, ease: "easeOut" }} className="overflow-hidden pt-12" aria-labelledby="riipen-project-title">
          <div className="grid gap-8 lg:grid-cols-[.8fr_1.2fr]">
            <div><p className="text-xs font-black uppercase tracking-[0.18em] text-[#e57356]">Project 01 / August 2026</p><h3 id="riipen-project-title" className="mt-5 text-3xl font-black leading-tight sm:text-4xl">Strategic Foresight Toolkit Design</h3><p className="mt-5 text-base leading-7 text-white/75">A Riipen project for Global Futures Laboratory through the ASU Student Employment Project Portal.</p><dl className="mt-8 divide-y divide-white/15 border-y border-white/15 text-sm"><div className="flex items-center justify-between gap-4 py-3"><dt className="text-white/55">Partner</dt><dd className="font-bold text-white">Global Futures Laboratory</dd></div><div className="flex items-center justify-between gap-4 py-3"><dt className="text-white/55">Project mentor</dt><dd className="font-bold text-white">Bea Rodriguez-Fransen</dd></div><div className="flex items-center justify-between gap-4 py-3"><dt className="text-white/55">Feedback</dt><dd className="font-bold text-[#a7d9d7]">5.0 overall rating</dd></div></dl></div>

            <div className="border border-white/20 bg-white/[0.06] p-6 sm:p-8"><p className="text-xs font-black uppercase tracking-[0.18em] text-[#a7d9d7]">The brief</p><p className="mt-4 text-xl font-bold leading-8 text-white">Transform existing Strategic Foresight content into an inviting, cohesive toolkit for university researchers - without making it feel corporate or academic-dry.</p><div className="mt-8 grid gap-8 md:grid-cols-2"><div><p className="text-xs font-black uppercase tracking-[0.16em] text-[#e57356]">Design approach</p><p className="mt-3 text-sm leading-7 text-white/70">Built a visual identity using ASU color, typography, and icons; then developed flexible layouts suitable for both print and digital use.</p></div><div><p className="text-xs font-black uppercase tracking-[0.16em] text-[#e57356]">Deliverables</p><p className="mt-3 text-sm leading-7 text-white/70">Completed visual identity guidance, print-ready toolkit layouts, digital toolkit files, and diagram and visual-metaphor assets.</p></div></div></div>
          </div>

          <div className="mt-10 grid gap-8 border-y border-white/20 py-10 lg:grid-cols-[.8fr_1.2fr]">
            <div><p className="text-xs font-black uppercase tracking-[0.18em] text-[#a7d9d7]">Analytical visualisation</p><h4 className="mt-4 text-2xl font-black leading-8">How simple language becomes an analytical visual.</h4><p className="mt-4 text-sm leading-7 text-white/70">The goal was not decoration. It was to make abstract strategic foresight concepts faster to scan, easier to compare, and more usable in real workshops.</p></div>
            <ol className="grid gap-4 sm:grid-cols-2"><li className="border-t border-white/20 pt-4"><p className="text-xs font-black text-[#e57356]">01 / DISTIL</p><p className="mt-2 text-sm leading-6 text-white/75">Identify the core idea, decision, or relationship in research-heavy source content.</p></li><li className="border-t border-white/20 pt-4"><p className="text-xs font-black text-[#e57356]">02 / ORGANISE</p><p className="mt-2 text-sm leading-6 text-white/75">Group concepts into a clear hierarchy that a workshop participant can follow quickly.</p></li><li className="border-t border-white/20 pt-4"><p className="text-xs font-black text-[#e57356]">03 / VISUALISE</p><p className="mt-2 text-sm leading-6 text-white/75">Translate relationships into modular layouts, diagrams, and visual metaphors rather than dense paragraphs.</p></li><li className="border-t border-white/20 pt-4"><p className="text-xs font-black text-[#e57356]">04 / APPLY</p><p className="mt-2 text-sm leading-6 text-white/75">Use consistent colors, typography, and formats so the toolkit works across digital and print settings.</p></li></ol>
          </div>
